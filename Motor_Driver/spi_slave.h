...
extern volatile spi_data spi_dint;
...
/*********************************/
/* Setear Configuracion Mecanica */
/*********************************/
// Uso: para calibrar velocidades y relaciones mecanicas del equipo
#define SCONFM        0xD2
//      Comando              1 1 0 1  0 0 1 0
//        Respuesta Esclavo => ACK (Basura)
//      Velocidad Lenta [1 Byte] %
//        Respuesta Esclavo => ACK (al comando)
//      Velocidad Rapida [1 Byte] %
//        Respuesta Esclavo => ACK (a la velocidad lenta)
//      Envia la relacion mecánica [1 Byte] (Con esto calcula las velocidades)
//        Respuesta Esclavo => ACK (a la velocidad rapida)
//      Fin del comando (FF=OK, EE=Ret) (Esto no seria de mucha utilidad, porque puede retransmitir)
//        Respuesta Esclavo => ACK (a la relacion mecanica)
